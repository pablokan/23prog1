...
for element in datos:
    ...
    if deuda > maxDeuda:
        ...
        deudor = apellido[1]
print("El mayor deudor es : ", deudor)
...
for element in datos:
    ...
    if ciudad == 'Río Cuarto':
        deuda = int(partes[2])
        deudaCiudad += deuda
print("La deuda total de los residentes de Río Cuarto es:", deudaCiudad)


#Los nombres de pila de los clientes cuyos DNI comiencen con 2 son: Elmore ,Wheeler
#Proceso 3

nombres = []
for element in datos:
    dni, nombre, deuda, localidad = element.split('#')
    numInicial = dni[0]
    if numInicial == "2":
        nombres.append(nombre.split()[0])
print("Personas con numero 2 de incial son : " ,nombres)
