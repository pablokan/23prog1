...
for persona in datos:
    ...
    nombrepila = nombre[0:posespacio]
    print(nombrepila)
...
print("la cantidad de personas que empiezan con el 2 son: " , c2, "se llaman: ",)"""
#no pude hacer nada mas, no termino de entender algunas cosas y me pongo mas nervioso al no entender, me preparo para el recuperatorio.