...
for persona in datos:
    dni, nombreYapellido, deuda, localidad = persona.split("#")
    apellido = nombreYapellido.split(" ")
    if contador < int(deuda):
        contador = int(deuda)
        mayorDeudor = apellido[1]
print("El  apellido del mayor deudor es:", mayorDeudor)
...
for persona in datos:
    ...
    if localidad == "Río Cuarto":
        total += int(deuda)
print("El total de deuda acumulada de los riocuartenses es de $", total)  
...
for persona in datos:
    dni, nombreYapellido, deuda, localidad = persona.split("#")
    nombre, apellido = nombreYapellido.split(" ")
    if dni[0] == "2":
        print("Los nombres de pila cuyos DNI comienzan en 2 son:", nombre)
