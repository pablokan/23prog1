...
buscar=input("Ingrese el nombre de la ciudad:")
ciudad=[]
...
for inversores in inversiones:
    Datos=inversores.split(",")
    Sexos=Datos[3].split()[-1]
    Info=inversiones.split(":")
    Dinero=Info[1].split("-")
    fecha=Info[2].split("/")
    año=fecha[2]
    mes=fecha[1]
    if año == 2021 and mes >= 7 and Sexos == "Male":
        Acum_dinero.append(dinero)
print(Acum_dinero)
