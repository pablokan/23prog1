...
iversorNombre = ["Veriee, Lizbeth, Tymon, Teddie, Dom, Armstrong, Micky, Mickie, Nadya,Donni, Dalli, Fiodor, Melesa, Orelle, Gayelor, Florencia, Pam, Olie, Wyn, Valled"] 
inversorCiudad =¨["Besancon, Jawand, Ribnita, Tlogoagung, Tonjongsari, Xianning, Dongping, Perm, Champaign, Normanton, Serra, Ccuntuma, Shihua, Huangtan, Sehwān, Buenavista, Maclear, Kebon, Gimry, Bungoma  "]
for x in range (len(inversorNombre)):
    if inversorNombre [x]:
        
print ("Ingresar nombre de Inversor..")
 

 #2)Decir el monto de la mayor inversión realizada en el 2022. 

montoMayor = 884_488.11
añoMonto = 2_022
for x in range (len(montoMayor)):
    if añoMonto [x]:
