...
#salida esperada: La cantidad de clientes de La Carlota es 4
...
print("La cantidad de clientes de La Carlota es:",clientes_carlota)
print("---------------------------------------------------------")

#El total de deuda acumulada de los clientes que deben más de 90 mil pesos.
#salida esperada: El total de deuda acumulada de los grandes deudores es de $1841808
...
for clientes in datos:
    ...
    deuda = int(deuda)
    if deuda >= 90000:
        deuda_mayor_90 = deuda_mayor_90 + deuda

print("El total de deuda acumulada de los grandes deudores es de:","$",deuda_mayor_90)
print("---------------------------------------------------------")
