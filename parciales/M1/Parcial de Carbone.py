...
ciudadingresada.append(datos)
contadordedatos = 4
datos = ciudad
for persona in ciudad:
    ciudadpersona = datos.find
    if ciudadpersona == ciudad:
        contadordedatos = 4
print("la cantidad de personas de la ciudad",ciudadingresada,"es de: ",contadordedatos)
...
print("La cantidad de clientes de La Carlota", clientes_carlota)
