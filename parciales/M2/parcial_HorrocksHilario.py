...
buscarNombre = input("Ingrese el nombre del inversor/a: ")
print("---------------------------------------------------------------------------------------------")
print("1)")
for inversor in inversores:
    ...
    nombre = datos[1]
    mail = datos[2]
    if nombre.lower() == buscarNombre.lower():
        
        print(f"El correo electrónico de {nombre} es {mail}")
        break
        
else:
        
    print(f"No se encontró ningún inversionista con el siguiente nombre : {buscarNombre}") 
...
for inversion in inversiones:
    ...
    fecha, fechaNum= parte2.split(":")
    dia, mes, año = fechaNum.split("/")
    monto1, monto2 = parte1.split("$")
    monto2 = float(monto2)
    if año == "2021":
        total_inversion += monto2
print("2)")
print("El total de las inversiones realizadas en 2021 es el siguiente: $",round(total_inversion,2))


contador_Inversoras = 0
...
for i in range(len(inversiones)):
    ...
    if año == 2022 and mes <= 6 and sexo == "Female":
        contador_Inversoras += 1
print("3)")
print("La cantidad de inversoras mujeres en el primer semestre del",año, "es:", contador_Inversoras)
print("---------------------------------------------------------------------------------------------")
