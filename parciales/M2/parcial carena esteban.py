...
def buscar_mail_por_nombre(nombre):
    for inversor in inversores:
        ...
        if datos[1].lower() == nombre.lower():
            return datos[2]
    return "No se encontró ningún inversor con ese nombre."
#inversiones
def obtener_total_inversiones_2021():
    total = 0
    ...
    return total
#inversiones, mujeres.
def inversiones_primer_semestre_2022_mujeres():
    count = 0
    for inversion in inversiones:
        if "2022" in inversion and "Female" in inversion:
            count += 1
    return count

#funciones
nombre_buscar = input("Ingrese el nombre del inversor: ")
mail_inversor = buscar_mail_por_nombre(nombre_buscar)
if mail_inversor != "No se encontró ningún inversor con ese nombre.":
    print("El mail de", nombre_buscar, "es:", mail_inversor)
else:
    print(mail_inversor)

total_inversiones_2021 = obtener_total_inversiones_2021()
print("Total de fondos del año 2021:", total_inversiones_2021)

count_primer_semestre_2022 = inversiones_primer_semestre_2022_mujeres()
print("Cantidad de inversiones de mujeres en el primer semestre del 2022:", count_primer_semestre_2022)
