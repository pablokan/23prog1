...
for inversor in inversores:
    ...
    nombre = datos[1]
    correo = datos[2]
print("El correo electrónico del inversor", nombre, "es:", correo)

#2) Obtener el total de todas las inversiones realizadas en el año 2021
totalF= 0
for dato1 in inversiones:
    inf, inf1 = dato1.split("-")
    dato, dato1= inf1.split(":")
    dia, mes, año = inf1.split("/")
    aux, mes = inf.split("$")
    mes = float(mes)
    if año == "2021":
        totalF = totalF + mes
...
for i in range(len(inversiones)):
    ...
    if año == 2022 and mes <= 6 and sexo == "Female":
        contadorinversorasmujeres += 1
print("3)")
print("La cantidad de inversoras mujeres en el primer semestre del",año, "es:", contadorinversorasmujeres)

#aprobame porfiiiiiiiiiiiiii