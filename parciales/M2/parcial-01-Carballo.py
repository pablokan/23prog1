...
nombre_abuscar =  input("ingrese nombre:")
correo_electronico = ""
...
for inversor in inversores:
    ...
    nombre = datos[1]
    email = datos[2]
    if nombre == nombre_abuscar:
        correo_electronico = email

if correo_electronico != "":
    print("El correo electrónico de", nombre_abuscar, "es:", correo_electronico)
...
for inversion in inversiones_2021:
