...
nombre_buscado =  input("ingrese nombre:")
correo_electronico = ""
...
if correo_electronico != "":
    print("El correo electrónico de", nombre_buscado, "es:", correo_electronico)
...
print("El total de todas las inversiones es: $" + str(total_inversiones))
...
print("La cantidad de inversoras mujeres en el primer semestre del",año, "es:", contador_femeninas)
