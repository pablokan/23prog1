...
nombreBuscado = input("Ingrese el nombre buscado: ")
...
for inversion in inversiones:
    fechaInicial = inversion.find("Fecha:") + len("Fecha:")  
    fecha = inversion[fechaInicial:fechaInicial + 10] 
    
    if fecha[-4:] == "2021":  
        montoDeinicio = inversion.find("$") + 1  
        montoFinal = inversion.find("-", montoDeinicio)  
        monto = float(inversion[montoDeinicio:montoFinal])  
        
        total += monto  

print("total de fondo del año 2021:", total)
