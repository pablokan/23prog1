...
print("-------------------------------------------------------------------------------------------------")
print("(1")#Buscar el mail de cualquier inversor por nombre y mostrarlo.
#salida esperada: El mail de Fionna es: fshanksterb@mashable.com
gmails=[]
mail= input("escribe un nombre de algún inversor para buscar su gmail: ")

for inversor in inversores:
    posComa= inversor.split(",")
    posName= posComa[1]
    if mail == posName:
        posGmail= posComa[2]
        gmails.append(posGmail)

print("el nombre del respectivo usuario es:", posGmail)
print("-------------------------------------------------------------------------------------------------")

print("(2")#Obtener el total de todas las inversiones realizadas en el año 2021
#Total de fondos del año 2021: $1679920.33
cant= 0
for data1 in inversiones:
    posBarra, posBarra1 = data1.split("-")
    date, date1= posBarra1.split(":")
    dia, mes, año = posBarra1.split("/")
    aux, monto = posBarra.split("$")
    monto = float(monto)
    if año == "2021":
        cant = cant + monto

print("el monto total es",round(cant))

print("-------------------------------------------------------------------------------------------------")
print("(3")#Saber cuantas inversiones fueron realizadas durante el primer semestre del año 2022 
#por inversoras de sexo femenino. Cantidad de inversiones de mujeres en el primer semestre del 2022: 4

for inversor in inversiones:
    espacios= inversor.split()
    posBarra= inversor[2].split("/")
#no entiendo profe :(
